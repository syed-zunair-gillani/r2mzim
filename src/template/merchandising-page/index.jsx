  ...
  return (
    <>
      ...
      <motion.section
        ...
        viewport={{ once: true }}
        variants={fadeIn}
        className="max-w-[1200px] flex flex-col bg-gray-50 lg:flex-row-reverse mx-auto gap-10 mb-10 px-3"
      >
      ...
      <motion.section
        ...
        viewport={{ once: true }}
        variants={fadeIn}
        className="max-w-[1200px] flex flex-col bg-gray-50 lg:flex-row mx-auto gap-10 mb-20 px-3"
      >
        <figure className="flex justify-center flex-1">
          <motion.img
            initial={{ opacity: 0, scale: 0.9 }}
